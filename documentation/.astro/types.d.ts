...
declare module 'astro:content' {
  ...
  type ContentEntryMap = {
    docs: {
      'components/Breadcrumbs/breadcrumb.md': {
        id: 'components/Breadcrumbs/breadcrumb.md';
        slug: 'components/breadcrumbs/breadcrumb';
        body: string;
        collection: 'docs';
        data: any;
      } & { render(): Render['.md'] };
      'components/Breadcrumbs/breadcrumbs.md': {
        id: 'components/Breadcrumbs/breadcrumbs.md';
        slug: 'components/breadcrumbs/breadcrumbs';
        body: string;
        collection: 'docs';
        data: any;
      } & { render(): Render['.md'] };
