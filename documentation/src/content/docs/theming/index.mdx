...
EasyDev uses styled-components to create styles so that you can easily customize components. Read this guide if you want to customize components in your app.
...
To create a new theme, you need to create an object as in the example where you can specify your own styles: colors, spacing etc.To customize theme, pass theme override object to EasydevProvider defaultTheme prop.
...
<EasydevProvider defaultTheme={theme}>
	<App>
		...
	</App>
</EasydevProvider>
...
For more information about changing the theme, see the [styled components documentation](https://styled-components.comadvanced)
