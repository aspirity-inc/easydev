...
export const getMenuItems = (themeType: string, currentPathName: string): LinkType[] => {
  return [
    {
      id: 0,
      icon: (
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          width="24"
          fill={
            currentPathName === '/showreels/shopping'
              ? themeType === 'light'
                ? '#178767'
                : '#93EDD4'
              : themeType === 'light'
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          width="24"
          fill={
            currentPathName === '/showreels/tables'
              ? themeType === 'light'
                ? '#178767'
                : '#93EDD4'
              : themeType === 'light'
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          width="24"
          fill={
            currentPathName === '/showreels/blog'
              ? themeType === 'light'
                ? '#178767'
                : '#93EDD4'
              : themeType === 'light'
